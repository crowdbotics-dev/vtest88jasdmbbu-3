"""
Django settings for vtest88jasdmbbu_3 project.
...
ROOT_URLCONF = 'vtest88jasdmbbu_3.urls'
...
WSGI_APPLICATION = 'vtest88jasdmbbu_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "vtest88jasdmbbu Support <support@vtest88jasdmbbu-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vtest88jasdmbbu_3 API",
    "DESCRIPTION": "API documentation for vtest88jasdmbbu_3 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "vtest88jasdmbbu_3.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "vtest88jasdmbbu_3.storage_backends.AzureStaticStorage"
